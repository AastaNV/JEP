...
# 5. Apply cublas patch
git clone https://github.com/apache/incubator-mxnet.git --branch v1.8.x --recursive mxnet
cd mxnet/
git apply ../mxnet_v1.8.x.patch
cd ..

# 6. Install onnx-onnxtrt
export PYVER=3.6
